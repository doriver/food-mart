package com.example.food_mart.common.exception;
...
public enum ErrorCode {
    ...
    // 출고
    , NOT_FOUND_OUTBOUND(HttpStatus.BAD_REQUEST, "해당 출고 내역을 찾을 수 없습니다.")
    , NOT_READY_OUTBOUND(HttpStatus.BAD_REQUEST, "READY 상태의 출고만 완료 처리할 수 있습니다.")
    ;
